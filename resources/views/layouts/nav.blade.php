       ...
       <div class="iq-navbar-custom">
           <nav class="navbar navbar-expand-lg navbar-light p-0">
               <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                   ...
                   <a href="../backend/index.blade.php" class="header-logo">
                       ...
                       <li class="caption-content">
                          <a href="#" class="iq-user-toggle d-flex align-items-center justify-content-between" id="h-dropdownMenuButton001" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           ...
                           <div class="dropdown-menu dropdown-menu-right w-100 border-0 py-2" aria-labelledby="h-dropdownMenuButton001">
                               <a class="dropdown-item mb-2" href="../app/user-profile.blade.php">
                                   <i class="lar la-user-circle font-size-20 mr-1"></i>
                                   <span class="mt-2">My Profile</span>
                               </a>
                               <a class="dropdown-item mb-2" href="../app/user-profile-edit.blade.php">
                                   <i class="las la-user-edit font-size-20 mr-1"></i>
                                   <span>Edit Profile</span>
                               </a>
                               <a class="dropdown-item mb-2" href="../app/user-account-setting.blade.php">
                                   <i class="las la-user-cog font-size-20 mr-1"></i>
                                   <span>Account Settings</span>
                               </a>
                               <a class="dropdown-item" href="../app/user-privacy-setting.blade.php">
                                   <i class="las la-user-shield font-size-20 mr-1"></i>
                                   <span>Privacy Settings</span>
                               </a>
                               <hr class="my-1">
                               <a class="dropdown-item" href="../backend/index.blade.php">
   ...
   <div class="iq-sidebar  sidebar-default ">
       ...
       <div class="sidebar-caption dropdown">
           ...
           <div class="dropdown-menu w-100 border-0 my-2" aria-labelledby="dropdownMenuButton">
               ...
               <a class="dropdown-item mb-3" href="../app/user-privacy-setting.blade.php">
                   <i class="las la-user-shield font-size-20 mr-1"></i>
                   <span>Privacy Settings</span>
               </a>
               <hr class="my-2">
               <a class="dropdown-item" href="../backend/auth-sign-in.blade.php">
                    ...
                    @csrf
                        ...
                        <x-dropdown-link :href="route('logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();" style="display: inline">
                        {{ __('Log Out') }}
                        </x-dropdown-link>
                    </form>
                </span>
       ...
       <div class="data-scrollbar" data-scroll="1">
           ...
           <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                   <li class="active">
                           <a href="../backend/index.blade.php" class="svg-icon">
                               <i>
                   ...
                   <li class="">
                       ...
                       <ul id="notebooks" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                           <li class="">
                               <a href="../backend/page-project-plans.blade.php" class="svg-icon">
                                   <i>
                           ...
                           <li class="">
                               <a href="../backend/page-routinenotes.blade.php" class="svg-icon">
                                   <i>
                           ...
                           <li class="">
                               <a href="../backend/page-planning.blade.php" class="svg-icon">
                                   <i>
                       ...
                       <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                           <li class="">
                               ...
                               <ul id="user" class="iq-submenu collapse" data-parent="#otherpage">
                                   <li class="">
                                       <a href="../app/user-profile.blade.php" class="svg-icon">
                                           <i class="">
                                   ...
                                   <li class="">
                                       <a href="../app/user-add.blade.php" class="svg-icon">
                                           <i class="">
                                   ...
                                   <li class="">
                                       <a href="../app/user-list.blade.php" class="svg-icon">
                                           <i class="">
                           ...
                           <li class="">
                               ...
                               <ul id="ui" class="iq-submenu collapse" data-parent="#otherpage">
                                       <li class="">
                                               <a href="../backend/ui-avatars.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-alerts.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-badges.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-breadcrumb.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-buttons.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-buttons-group.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-boxshadow.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-colors.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-cards.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-carousel.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-grid.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-helper-classes.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-images.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-list-group.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-media-object.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-modal.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-notifications.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-pagination.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-popovers.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-progressbars.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-typography.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-tabs.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-tooltips.blade.php" class="svg-icon">
                                                   <i class="">
                                       ...
                                       <li class="">
                                               <a href="../backend/ui-embed-video.blade.php" class="svg-icon">
                                                   <i class="">
                           ...
                           <li class="">
                               ...
                               <ul id="auth" class="iq-submenu collapse" data-parent="#otherpage">
                                   <li class="">
                                       <a href="../backend/auth-sign-in.blade.php" class="svg-icon">
                                           <i class="">
                                   ...
                                   <li class="">
                                       <a href="../backend/auth-sign-up.blade.php" class="svg-icon">
                                           <i class="">
                                   ...
                                   <li class="">
                                       <a href="../backend/auth-recoverpw.blade.php" class="svg-icon">
                                           <i class="">
                                   ...
                                   <li class="">
                                       <a href="../backend/auth-confirm-mail.blade.php" class="svg-icon">
                                           <i class="">
                                   ...
                                   <li class="">
                                       <a href="../backend/auth-lock-screen.blade.php" class="svg-icon">
                                           <i class="">
                           ...
                           <li class="">
                               ...
                               <ul id="pricing" class="iq-submenu collapse" data-parent="#otherpage">
                                       <li class="">
                                           <a href="../backend/pricing.blade.php" class="svg-icon">
                                               <i class="">
                                       ...
                                       <li class="">
                                           <a href="../backend/pricing-1.blade.php" class="svg-icon">
                                               <i class="">
                           ...
                           <li class="">
                               ...
                               <ul id="pages-error" class="iq-submenu collapse" data-parent="#otherpage">
                                   <li class="">
                                       <a href="../backend/pages-error.blade.php" class="svg-icon">
                                           <i class="">
                                   ...
                                   <li class="">
                                       <a href="../backend/pages-error-500.blade.php" class="svg-icon">
                                           <i class="">
                           ...
                           <li class="">
                               <a href="../backend/pages-blank-page.blade.php" class="svg-icon">
                                   <i class="">
                           ...
                           <li class="">
                               <a href="../backend/pages-maintenance.blade.php" class="svg-icon">
                                   <i class="">
